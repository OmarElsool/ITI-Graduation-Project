...
//let date1 = document.querySelector(".checkInjs");
//let date2 = document.querySelector(".checkOutjs");
//let resultSpan = document.querySelector(".price-days");
//let date1Value;
//let date2Value;
//if (date1) {
...
//        resultSpan = date1Value - date2Value
...
addEventClearbtn = document.querySelector(".clear-btn");
...
//function to add days in days with class day and prev-date next-date on previous month  
//and next month days and active on today
